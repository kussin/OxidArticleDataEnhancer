...
trait LoggerTrait
{
    ...
    private function _getLogger()
    {
        if ($this->_oLogger === null) {
            ...
            // SET LOG FILENAME
            $sLogfilePath = trim(Registry::getConfig()->getConfigParam('sKussinArticleDataEnhancerLogFilename'));
    ...
    {
        // DEBUG MODE
        $bDebugMode = (bool) Registry::getConfig()->getConfigParam('blKussinArticleDataEnhancerDebugEnabled');
